    ...
    <table class="table table-light table-bordered">
        <tbody>
            <tr>
                ...
                <th width="20%" class="text-center">TotalUnitario</th>
...
function imprimirFactura() {
    ...
    ventana.document.write('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css">');
